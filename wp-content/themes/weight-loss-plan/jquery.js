...
$(document).ready(function() {
	...
	// Clickable company block
	$('.js-reference-to').on('click', function () {
		/*if(typeof $(this).attr('data-target') != "undefined") {
		 ...
		 'event': 'gtm.click',
		 'gtm.elementUrl': $(this).attr('data-url')
		 });
	});
	...
	// Show mobile menu when scroll page UP, but hide when scroll DOWN
	...
	// 			$('.view-header').show();
	// 		} else if(prevScroll < $(window).scrollTop() && !$('.collapse.navbar-collapse').hasClass('show')) {
	// 			$('.view-header').hide();
	// 		}
	// 	}, 200);
